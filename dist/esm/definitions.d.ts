...
export type YandexAdsEventName = 'bannerLoaded' | 'bannerClicked' | 'bannerImpression' | 'bannerFailedToLoad' | 'interstitialLoaded' | 'interstitialShown' | 'interstitialClicked' | 'interstitialImpression' | 'interstitialDismissed' | 'interstitialFailedToLoad' | 'interstitialFailedToShow' | 'rewardedLoaded' | 'rewardedShown' | 'rewardedClicked' | 'rewardedImpression' | 'rewardedDismissed' | 'rewardedFailedToLoad' | 'rewardedFailedToShow' | 'rewarded';
